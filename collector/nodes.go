	...
	return &Nodes{
		...
		nodeMetrics: []*nodeMetric{
			...
			},
			{
				Type: prometheus.GaugeValue,
				Desc: prometheus.NewDesc(
					prometheus.BuildFQName(namespace, "jvm_memory", "used_gbytes"),
					"JVM memory currently used by area",
					append(defaultNodeLabels, "area"), nil,
				),
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.HeapUsed)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
			...
			},
			{
				...
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.NonHeapUsed)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
			...
			},
			{
				Type: prometheus.GaugeValue,
				Desc: prometheus.NewDesc(
					prometheus.BuildFQName(namespace, "jvm_memory", "max_gbytes"),
					"JVM memory max",
					append(defaultNodeLabels, "area"), nil,
				),
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.HeapMax)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
					return append(defaultNodeLabelValues(cluster, node), "heap")
			...
			},
			{
				Type: prometheus.GaugeValue,
				Desc: prometheus.NewDesc(
					prometheus.BuildFQName(namespace, "jvm_memory", "committed_gbytes"),
					"JVM memory currently committed by area",
					append(defaultNodeLabels, "area"), nil,
				),
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.HeapCommitted)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
					return append(defaultNodeLabelValues(cluster, node), "heap")
			...
			},
			{
				...
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.NonHeapCommitted)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
					return append(defaultNodeLabelValues(cluster, node), "non-heap")
			...
			},
			{
				Type: prometheus.GaugeValue,
				Desc: prometheus.NewDesc(
					prometheus.BuildFQName(namespace, "jvm_memory_pool", "used_gbytes"),
					"JVM memory currently used by pool",
					append(defaultNodeLabels, "pool"), nil,
				),
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.Pools["young"].Used)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
			...
			},
			{
				Type: prometheus.CounterValue,
				Desc: prometheus.NewDesc(
					prometheus.BuildFQName(namespace, "jvm_memory_pool", "max_gbytes"),
					"JVM memory max by pool",
					append(defaultNodeLabels, "pool"), nil,
				),
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.Pools["young"].Max)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
					return append(defaultNodeLabelValues(cluster, node), "young")
			...
			},
			{
				Type: prometheus.CounterValue,
				Desc: prometheus.NewDesc(
					prometheus.BuildFQName(namespace, "jvm_memory_pool", "peak_used_gbytes"),
					"JVM memory peak used by pool",
					append(defaultNodeLabels, "pool"), nil,
				),
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.Pools["young"].PeakUsed)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
					return append(defaultNodeLabelValues(cluster, node), "young")
			...
			},
			{
				Type: prometheus.CounterValue,
				Desc: prometheus.NewDesc(
					prometheus.BuildFQName(namespace, "jvm_memory_pool", "peak_max_gbytes"),
					"JVM memory peak max by pool",
					append(defaultNodeLabels, "pool"), nil,
				),
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.Pools["young"].PeakMax)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
					return append(defaultNodeLabelValues(cluster, node), "young")
			...
			},
			{
				...
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.Pools["survivor"].Used)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
			...
			},
			{
				...
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.Pools["survivor"].Max)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
					return append(defaultNodeLabelValues(cluster, node), "survivor")
			...
			},
			{
				...
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.Pools["survivor"].PeakUsed)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
					return append(defaultNodeLabelValues(cluster, node), "survivor")
			...
			},
			{
				...
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.Pools["survivor"].PeakMax)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
					return append(defaultNodeLabelValues(cluster, node), "survivor")
			...
			},
			{
				...
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.Pools["old"].Used)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
			...
			},
			{
				...
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.Pools["old"].Max)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
					return append(defaultNodeLabelValues(cluster, node), "old")
			...
			},
			{
				...
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.Pools["old"].PeakUsed)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
					return append(defaultNodeLabelValues(cluster, node), "old")
			...
			},
			{
				...
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.Mem.Pools["old"].PeakMax)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
					return append(defaultNodeLabelValues(cluster, node), "old")
			...
			},
			{
				Type: prometheus.GaugeValue,
				Desc: prometheus.NewDesc(
					prometheus.BuildFQName(namespace, "jvm_buffer_pool", "used_gbytes"),
					"JVM buffer currently used",
					append(defaultNodeLabels, "type"), nil,
				),
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.BufferPools["direct"].Used)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
			...
			},
			{
				...
				Value: func(node NodeStatsNodeResponse) float64 {
					Value, _ := strconv.ParseFloat(fmt.Sprintf("%.2f", float64(node.JVM.BufferPools["mapped"].Used)/1024/1024/1024), 64)
					return Value
				},
				Labels: func(cluster string, node NodeStatsNodeResponse) []string {
